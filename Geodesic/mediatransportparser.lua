...
local function listhandler(buff)
...
local function patternhandler(buff)
    local dir = buff:read()
    local length = buff:readInt()
    local anglesig = {}
    for i = 1, length, 1 do
...
local function doublehandler(buff)
...
local function stringhandler(buff)
    local length = buff:readInt()
    local str = ""
    for i = 1, length, 1 do
...
local function texthandler(buff) -- Minor display difference from stringhandler(), text and string iotas share the same format
    local length = buff:readInt()
    local str = ""
    for i = 1, length, 1 do
        local char_num = buff:read()
...
local function vectorhandler(buff)
...
local function matrixhandler(buff)
